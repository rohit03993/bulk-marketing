                            ...
                            @else
                                @foreach ($phones as $p)
                                    <div class="flex items-center justify-between gap-3 py-2 px-2 rounded-xl hover:bg-slate-50">
                                        ...
                                        <a href="tel:{{ preg_replace('/\D+/', '', $p) }}" class="inline-flex items-center px-3 py-1.5 rounded-xl bg-emerald-600 text-white text-xs font-semibold hover:bg-emerald-700">
                                            {{ __('Call') }}
                                        </a>
                                    </div>
                                @endforeach
